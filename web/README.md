...
| Edit overview | Assets tab | Beat detection | Text font sync | Export tab |
| --- | --- | --- | --- | --- |
| ![Edit overview](./screenshots/edit-overview.png) | ![Assets](./screenshots/assets.png) | ![Beat detection](./screenshots/beat-detect.png) | ![Text font sync](./screenshots/timeline.png) | ![Export](./screenshots/export.png) |
